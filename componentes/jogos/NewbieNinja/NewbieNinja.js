...
const NewbieNinja = new TelaObject("Tfan Studios | Newbie Ninja", "newbie-ninja", false);

NewbieNinja.CriarConteudo(`
    <div class="container d-flex align-items-center justify-content-between flex-column">
      <div class="w-100 box-game-info bg bg-dark tex d-flex justify-content-center">
        ...
        <h1 class="w-25 text-center text-light">Newbie Ninja</h1>
      ...
      <div id="unity-container" class="unity-desktop">
        <canvas id="unity-canvas" width=350 height=200 tabindex="-1"></canvas>
...
script.innerHTML = `
      ...
      var buildUrl = "../../componentes/jogos/NewbieNinja/Build";
      ...
      var config = {
        ...
        companyName: "Stefan Lucas",
        productName: "Newbie Ninja",
        productVersion: "0.5",
      ...
      script.onload = () => {
        createUnityInstance(canvas, config, (progress) => {
          progressBarFull.style.width = 100 * progress + "%";
                ...
                btnSound.onclick = () => {
                  unityInstance.SendMessage("GameController", "TrilhaSonoraOnOff");
                  unityInstance.SendMessage("GameController", "EfeitosSonorosOnOff");
...
NewbieNinja.SetScript(script);

export default NewbieNinja;