...
const ZombieAtack = new TelaObject("Tfan Studios | Zombie Atack", "zombie-atack", false);

ZombieAtack.CriarConteudo(
    `
    <div class="container d-flex align-items-center justify-content-between flex-column">
      <div class="w-100 box-game-info bg bg-dark tex d-flex justify-content-center">
        ...
        <h1 class="w-50 text-center text-light">Zombie Atack</h1>
...
script.innerHTML = `
    ...
    var buildUrl = "../../componentes/jogos/ZombieAtack/Build";
...
ZombieAtack.SetScript(script);

export default ZombieAtack;
